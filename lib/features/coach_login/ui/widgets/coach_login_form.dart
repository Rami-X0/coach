...
class CoachLoginForm extends StatefulWidget {
  const CoachLoginForm({super.key});

  @override
  State<CoachLoginForm> createState() => _CoachLoginFormState();
}

class _CoachLoginFormState extends State<CoachLoginForm> {
  ...
  Widget build(BuildContext context) {
    return Form(
      key: context.read<CoachLoginCubit>().formKey,
      child: Column(
        children: [
          ...
          AppTextFormField(
            ...
            controller: context.read<CoachLoginCubit>().emailController,
            hintText: 'email',
            suffixIcon: FaIcon(
          ...
          AppTextFormField(
            ...
            controller: context.read<CoachLoginCubit>().passwordController,
            hintText: 'password',
