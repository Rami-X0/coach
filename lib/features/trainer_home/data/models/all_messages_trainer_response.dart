...
part 'all_messages_trainer_response.g.dart';

@JsonSerializable()
class AllMessageTrainerResponse {
  ...
  factory AllMessageTrainerResponse.fromJson(Map<String, dynamic> json) =>
      _$AllMessageTrainerResponseFromJson(json);

  Map<String, dynamic> toJson() => _$AllMessageTrainerResponseToJson(this);
}
