...
class BlocListenerTrainerSignUp extends StatelessWidget {
  const BlocListenerTrainerSignUp({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocListener<TrainerSignUpCubit, TrainerSignUpState>(
